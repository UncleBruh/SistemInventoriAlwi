                            ...
                            <tbody>
                                @forelse ($data as $item)
                                    <tr class="hover:bg-gray-50">
                                        <td class="py-3 px-4 border-b text-sm font-bold text-indigo-700">{{ $item->kode_transaksi ?? 'N/A' }}</td>
                                        <td class="py-3 px-4 border-b text-sm font-semibold text-indigo-600">{{ $item->no_nota ?? 'LAMA-' . $item->id_penjualan }}</td>
