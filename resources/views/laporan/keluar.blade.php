<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-6">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <form method="GET" action="{{ route('laporan.keluar') }}" class="mb-6 flex flex-wrap gap-4 items-end bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div>
                ...
                <div class="flex gap-2">
                    ...
                    <!-- Tombol Cetak PDF -->
                    <!-- Catatan: Jika error route not found, ganti 'laporan.keluar.pdf' dengan nama route aslimu di web.php -->
                    <a href="{{ route('laporan.keluar.pdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 transition">
                        🖨️ Cetak PDF
                    </a>
                </div>
            </form>
