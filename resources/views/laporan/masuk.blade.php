                    ...
                    <tbody>
                        @forelse ($mutasiMasuk as $index => $item)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="py-2 px-4 border-b text-center text-sm font-bold text-green-600">+{{ $item->jumlah_perubahan }} Pcs</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" class="py-6 px-4 text-center text-gray-500 italic">Tidak ada data barang masuk untuk periode ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
